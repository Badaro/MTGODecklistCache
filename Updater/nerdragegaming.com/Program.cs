...
namespace Updater
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            foreach (MtgGoldfishTournament tournament in TournamentLoader.GetTournaments(rawFolder))
            {
                ...
                var details = TournamentDetailsLoader.GetTournamentDetails($"{tournament.Uri.ToString()}");
